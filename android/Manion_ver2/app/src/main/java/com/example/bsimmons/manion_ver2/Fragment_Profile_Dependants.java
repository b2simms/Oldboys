...
public class Fragment_Profile_Dependants extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_profile_dependents, container, false);
    }
    ...
    public void onStart() {
        ...
        listView = (ListView) getView().findViewById(R.id.dependantList);
